...
> A modern landing page built with Next.js to present the Blumenau Colchões store, focusing on performance, accessibility, and an outstanding user experience.
...
* **next/font** - For automated optimization of fonts, reducing page load times.
